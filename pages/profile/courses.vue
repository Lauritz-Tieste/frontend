<template>
  <main class="grid-auto gap-card container h-screen-inner min pb-container pt-container grid-rows-[auto_auto_1fr]">
    <FormSearch class="justify-self-end col-span-full" placeholder="Body.SearchCourses" v-model="filters.search_term" />

    <Sort class="mb-card-sm col-span-full" :quantity="myCourses.length" :options="options"
